// src/routes/analytics.route.mjs
// ---------------------------------------------------------------------------
// ESM-based Analytics routes for business and transactional reporting.
//
// These endpoints query aggregation pipelines and metrics on database models.
// ---------------------------------------------------------------------------

import express from "express";
import * as analytics from "../controllers/analytics.controller.mjs";
